...
- Ensure we can chain methods ([67c06be](https://github.com/goliatone/go-router/commit/67c06be966035479575db657d09992d370376c04))  - (goliatone)
- Ensure we can chain methods ([e2e4bef](https://github.com/goliatone/go-router/commit/e2e4befcf52bc4fee0b346eb99962d0a7cefad7c))  - (goliatone)
...
- Static method and Head ([aff2b7d](https://github.com/goliatone/go-router/commit/aff2b7db4e14e0a9f8952f4eb1d8efb43cc7ffc3))  - (goliatone)
...
- Static method and Head ([b85f621](https://github.com/goliatone/go-router/commit/b85f62141cbe6567e099dbf634d8bcb0c4fae82e))  - (goliatone)
...
- New context methods ([e0c4f1f](https://github.com/goliatone/go-router/commit/e0c4f1fb0e42090db36844e02a750714cba18946))  - (goliatone)
...
- Test data for view rendering ([7c399e7](https://github.com/goliatone/go-router/commit/7c399e7040ce5be074cf3892580c94ea3494d9c7))  - (goliatone)
- Flash middleware ([415232a](https://github.com/goliatone/go-router/commit/415232aca73e29a28c10e264af495bb959d16dff))  - (goliatone)
- Flash middleware ([8d03228](https://github.com/goliatone/go-router/commit/8d0322822922af94c052900e6347f70aefefbbac))  - (goliatone)
...
- We might want to register the name once is set ([8bc7c0f](https://github.com/goliatone/go-router/commit/8bc7c0f3c5bc263cabce406a8c7a4f1e68cbf9fc))  - (goliatone)
...
- Context methods to render HTML and use views ([83bf97a](https://github.com/goliatone/go-router/commit/83bf97a3d56dfc4e3264f73d8e0189f370edd98d))  - (goliatone)
- Context methods to render HTML and use views ([8fd761e](https://github.com/goliatone/go-router/commit/8fd761ee3f25908f588ae0f83bc4f34f51298551))  - (goliatone)
...
- Default rendering using Go template ([1cb254e](https://github.com/goliatone/go-router/commit/1cb254e43691ffe3f17c2eb6130e663619f4162f))  - (goliatone)
...
- New router method, to register groups using a callback ([5b872f2](https://github.com/goliatone/go-router/commit/5b872f29b13bf2ce222187bcd65bd5563ecfad92))  - (goliatone)
- New router method, to register groups using a callback ([315f202](https://github.com/goliatone/go-router/commit/315f20207c38268e8f535a7b78a0c9bd93a578a3))  - (goliatone)
...
- Make router init async with late routes ([86e3b50](https://github.com/goliatone/go-router/commit/86e3b502a5453f7798e1e9d6a360c42fa30c1a9c))  - (goliatone)
- Make router init async with late routes ([7a1e0cb](https://github.com/goliatone/go-router/commit/7a1e0cb3af5c8079a9cd2194cf001f9008003441))  - (goliatone)
- Make router init async with late routes ([83757e2](https://github.com/goliatone/go-router/commit/83757e26f2b62e32ad6b13ccfbc69ba73057a66b))  - (goliatone)
...
- Make router init async ([abbdd35](https://github.com/goliatone/go-router/commit/abbdd35d80b046ded55bc9955f78e833c7de205e))  - (goliatone)
...
- Update deps ([382362d](https://github.com/goliatone/go-router/commit/382362d2566301663da10b8e5bef2960c9b4a0fe))  - (goliatone)
...
- Update deps ([53ed081](https://github.com/goliatone/go-router/commit/53ed081513fef6ef4f0294233a44f521c4440191))  - (goliatone)
...
- Test for builder ([9d5c0a3](https://github.com/goliatone/go-router/commit/9d5c0a36a855a20aa1aa82d7ba0c2131f1ffd307))  - (goliatone)
...
- NewValidationError take validation errors ([442ac2e](https://github.com/goliatone/go-router/commit/442ac2ecd28a750b65431369864bddb3daf1ce88))  - (goliatone)
...
- Summary to meta ([eea99f1](https://github.com/goliatone/go-router/commit/eea99f1a00f4ccb83d904140bbdd7434c637d467))  - (goliatone)
...
- Meta and openapi ([399ef30](https://github.com/goliatone/go-router/commit/399ef3040fef7abc21000e58f9e9217b6eb6b47c))  - (goliatone)
...
- Impelement ContextStore ([903e4ab](https://github.com/goliatone/go-router/commit/903e4ab7694cd410d07ab4b5babf107b565fba15))  - (goliatone)
- Impelement ContextStore ([5e16b18](https://github.com/goliatone/go-router/commit/5e16b183dd4bf95348c4ce07e6f975c403fdc9a9))  - (goliatone)
- Impelement ContextStore ([892a885](https://github.com/goliatone/go-router/commit/892a885c3ed0377283d64aa1c553809a18273069))  - (goliatone)
...
- Log function ([76e2cce](https://github.com/goliatone/go-router/commit/76e2cce826f9364ff65835941376e4068f460a14))  - (goliatone)
...
- Break down Context interface in Response and Request ([abc2561](https://github.com/goliatone/go-router/commit/abc2561b6249c2fa1ba08018f6e96ebe27de102a))  - (goliatone)
- Break down Context interface in Response and Request ([7c641db](https://github.com/goliatone/go-router/commit/7c641dbe59c251b656956696bb6b9e61c0f350c1))  - (goliatone)
...
- Update example to match new interfaces ([29b8110](https://github.com/goliatone/go-router/commit/29b811076b465f803eaf58a49a6ccb4a5b71d380))  - (goliatone)
...
- Add metadata support for routes ([7f7963f](https://github.com/goliatone/go-router/commit/7f7963f8a0c508f91c3bef920dd897136efe59d5))  - (goliatone)
...
- Make route info metadata ([3e250dd](https://github.com/goliatone/go-router/commit/3e250ddc9cc2ec2b23134335b032ce2507eb3e5e))  - (goliatone)
- Update example to match new interfaces ([2aee77f](https://github.com/goliatone/go-router/commit/2aee77f4399c773908fe917306ebc749a0c7770c))  - (goliatone)
...
- Refactor API interface to use MiddlewareFun ([7d6717f](https://github.com/goliatone/go-router/commit/7d6717f520dadf9f9b07bc2927c9a261df5098b3))  - (goliatone)
- Refactor API interface to use MiddlewareFun ([4b5ef8b](https://github.com/goliatone/go-router/commit/4b5ef8b8da6a2a372110d5f9dd652c947adab7ed))  - (goliatone)
- Refactor API interface to use MiddlewareFun ([ed42893](https://github.com/goliatone/go-router/commit/ed42893544e0818539faaf9532c548aab55a1075))  - (goliatone)
- Refactor API interface to use MiddlewareFun ([0e25c14](https://github.com/goliatone/go-router/commit/0e25c147afa93b7ca1f686844222becb1abbf6bd))  - (goliatone)
- Refactor API interface to use MiddlewareFun ([248faba](https://github.com/goliatone/go-router/commit/248fabad3ec7e82d747c81a6f2e846a2923c5415))  - (goliatone)
- Refactor API interface to use MiddlewareFun ([0024e43](https://github.com/goliatone/go-router/commit/0024e43581c3c8101b61a65ff9bbaa1f99dc577b))  - (goliatone)
...
- Update example to match new interfaces ([5638f7f](https://github.com/goliatone/go-router/commit/5638f7fadfacb527d43a0e0f5988673d50729bbf))  - (goliatone)

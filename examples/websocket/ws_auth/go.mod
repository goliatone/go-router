module ws-auth-example

go 1.23.4

replace github.com/goliatone/go-router => ../../..

replace github.com/goliatone/go-auth => /Users/goliatone/Development/GO/src/github.com/goliatone/go-auth

require (
	github.com/golang-jwt/jwt/v5 v5.2.1
	github.com/goliatone/go-auth v0.0.0
